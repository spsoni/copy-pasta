...
![Copy-Pasta][file:copy-pasta-dark]
![Copy-Pasta][file:copy-pasta-light]

> [!NOTE]
> Click the <kbd>Use this template</kbd> button and clone it in IntelliJ IDEA.

<!-- Plugin description -->
**Copy-Pasta** is a repository that provides a pure template to make it easier to create a new plugin project (check the [Creating a repository from a template][gh:template] article).
...
A project built using the Copy-Pasta includes a Gradle configuration already set up.
...
A generated Copy-Pasta repository contains the following content structure:
...
The Copy-Pasta project provides integration of two testing approaches – functional and UI tests.
...
To increase the project value, Copy-Pasta got integrated with [Qodana][jb:qodana], a code quality monitoring platform that allows you to check the condition of your implementation and find any possible problems that may require enhancing.
...
## [Unreleased]
### Added
- Initial scaffold created from Copy-Pasta
```
...
[file:copy-pasta-dark]: ./.github/readme/copy-pasta-dark.svg#gh-dark-mode-only
[file:copy-pasta-light]: ./.github/readme/copy-pasta-light.svg#gh-light-mode-only
